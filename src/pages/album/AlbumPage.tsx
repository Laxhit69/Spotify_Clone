...
export const formatDuration = (duration: number) => {
    ...
    // ensures seconds are always 2 digits like 01, 09, 15
}
...
const AlbumPage = () => {
    ...
    const handlePlayAlbum = () => { // isme we are clicking on the play button of the album to start playing
    ...
    const handlePlaySong = (index : number) => {  //isme we are clicking on the songs to start playing 
        if(!currentAlbum) return;
